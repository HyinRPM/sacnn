...
class net_one_neuron_ff_sa_cnn(nn.Module):
    def __init__(self):
        super().__init__()
...
class seperate_core_model_ff_sa_cnn(nn.Module):
    def __init__(self,num_neurons):
        super().__init__()
        self.models = nn.ModuleList([net_one_neuron_ff_sa_cnn() for i in range(num_neurons)])
...
def model_ff_sa_cnn(num_neurons):
    return seperate_core_model_ff_sa_cnn(num_neurons=num_neurons)

def model_ff_sa_cnn_one_neuron():
	 return net_one_neuron_ff_sa_cnn()